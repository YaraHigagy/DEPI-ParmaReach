...
![ERD Diagram](./Assets/imgs/PharmaReach-ERD.jpg)

## Setup Instructions
Follow these steps to set up the PharmaReachDB database:

1. **Clone the Repository**:
   ```bash
   git clone https://github.com/your-repo/pharmareach-db.git

2. **Run the Schema Script**:
    Execute the schema.sql file included in this repository to create all tables.

3. **Extend the Schema**:
    Modify or add new tables to meet additional requirements.
